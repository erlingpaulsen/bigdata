...
def deleteVariables(struct, varlist):
    """
    deleteVariables(struct, variables) deletes the variables in varlist from
    the struct.variables dictionary.
    
    Input:
        - struct: A data struct to process
        - varlist: A list of variables you want to delete from struct
